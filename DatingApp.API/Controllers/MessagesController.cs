...
namespace DatingApp.API.Controllers
{
    ...
    public class MessagesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetMessagesForUser(int userId, [FromQuery]MessageParams messageParams)
        {
            ...
            var messages = _mapper.Map<IEnumerable<MessageToReturnDto>>(messsagesFromRepo);

            Response.AddPagination(messsagesFromRepo.CurrentPage, messsagesFromRepo.PageSize, 
                messsagesFromRepo.TotalCount, messsagesFromRepo.TotalPages);
